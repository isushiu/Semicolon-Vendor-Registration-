      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white" href="insert.php">
            ...
            <span class="nav-link-text ms-0">Staff Registration</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" href="insertVendorOwner.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">shop</i>
            </div>
            <span class="nav-link-text ms-0">Vendor Owner Registration</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" href="../../vendors/logout.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">exit_to_app</i>
            </div>
            <span class="nav-link-text ms-0">Logout</span>
          </a>
        </li>
      </ul>
    </div>
